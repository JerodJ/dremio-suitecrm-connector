...
@SourceType(value = "SuiteCRMARP", label = "SuiteCRM",uiConfig = "suitecrm-layout.json")
public class SuiteCRMConf extends AbstractArpConf<SuiteCRMConf> {
  private static final String ARP_FILENAME = "arp/implementation/suitecrm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.suitecrm.SuiteCRMDriver";
